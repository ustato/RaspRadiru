...
bot_token = yaml_dict['slack_bottoken']
self_token = yaml_dict['slack_selftoken']
c_name = yaml_dict['slack_channel']
url = "https://slack.com/api/channels.list?token=" + self_token
...
for attr in entries:
    url2 = "https://slack.com/api/files.list?token=" + self_token + "&channel=" + attr['id']
    ...
    try:
        ...
        attr2 = entries2[-1]
        url2 = "https://slack.com/api/files.delete?token=" + bot_token + "&file=" + attr2['id']
        headers2 = {"content-type": "application/json"}
        r2 = requests.get(url2 ,headers=headers2)
        json_data2 = r2.json()
    except KeyError:
